...
func (k keyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Enter, k.LaunchWindow, k.LaunchTab, k.LaunchPane, k.LaunchAll, k.Search, k.Filter, k.Sort, k.Preview, k.ViewPlan, k.Timeline, k.Hide, k.Star, k.Note, k.CopyID, k.CopyPreview, k.Export, k.JumpNextAttention, k.FilterAttention, k.ResumeInterrupted, k.ScanWorkStatus, k.ExpandCollapseAll, k.OpenFile, k.ViewSwitch, k.Config, k.Help, k.Quit}
}
...
func (k keyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.Preview, k.PreviewPosition, k.PreviewScrollUp, k.PreviewScrollDown, k.ConversationSort, k.ViewPlan, k.Timeline, k.CopyID, k.CopyPreview, k.Export, k.OpenFile, k.Reindex, k.ScanWorkStatus, k.ViewSwitch, k.Config},
