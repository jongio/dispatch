...
//
// scheme.go holds the Theme (derived semantic styles) type plus
// color-blending helpers.  The raw ColorScheme type lives in
// internal/config to avoid an upward dependency from config → styles.
package styles
...
func DeriveTheme(cs config.ColorScheme) *Theme {
