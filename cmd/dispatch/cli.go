...
_dispatch_completion() {
  ...
  local commands="help version open new doctor update completion stats search tags aliases alias compare prune tag watch config export info man"
...
_dispatch_completion() {
  ...
  local bin=${words[1]}
  commands=(help version open new doctor update completion stats search tags aliases alias compare prune tag watch config export info man)
...
for bin in dispatch disp
  complete -c $bin -f
  complete -c $bin -n '__dispatch_needs_command' -a 'help version open new doctor update completion stats search tags aliases alias compare prune tag watch config export info man'
