...
var manCommands = []manEntry{
	...
	{"open <id> [--mode M]", "Resume a session by ID or alias (M: inplace, tab, window, pane). Use --last for the most recent session, --repo/--branch/--folder/--current to select the newest scoped session, and --print to write the resume command instead of launching."},
	...
	{"resume [query] [flags]", "Select and resume a session under the current directory. Use --folder to select another directory; explicit output flags remain non-interactive."},
	...
	{"notes [list] [--json|--csv|--markdown]", "List, get, set, or clear session notes."},
