...
9. **/** → Focus Search Bar / Open Search
...
10. **Esc** → Clear Search Query or Back to List
...
13. **S** (Shift+S) → Toggle Sort Direction
...
16. **PgUp (Page Up)** → Preview Panel Scroll Up
...
17. **PgDn (Page Down)** → Preview Panel Scroll Down
...
20. **H** (Shift+H) → Toggle Hidden Sessions Visibility
...
24. **4** → Set Time Range to All Time
...
28. **Up Arrow / k** → Blur Search and Move Selection Up
...
33. **↑ (Up Arrow)** → Move Up in Filter List
...
38. **Enter** → Apply Filters and Close Panel
...
39. **Esc** → Cancel and Close Filter Panel
...
40. **↑ (Up Arrow)** → Move Up in Shell List
...
### Non-Edit Mode
44. **↑ (Up Arrow)** → Move Up in Config Options
...
45. **↓ (Down Arrow)** → Move Down in Config Options
...
48. **Esc** → Cancel Edit of Current Field
...
49. **Enter** → Confirm Edit of Current Field
...
50. **Any Printable Character** (a-z, A-Z, 0-9, spaces, etc.)
...
53. **Single Click on Session** → Select Session
...
54. **Double Click on Session** → Launch Session
...
55. **Double Click on Folder + Ctrl** → Launch New Session in Window
...
56. **Double Click on Folder + Shift** → Launch New Session in Tab
    - Handler: D:\code\dispatch\internal\tui\model.go (lines 1127-1135)
...
57. **Double Click on Folder** → Launch New Session with Default Mode
    - Handler: D:\code\dispatch\internal\tui\model.go (lines 1127-1135)
    - Behavior: Creates new session in folder's path
    - Condition: Double-click on folder item (no modifiers)

58. **Click on Header Area (Search Bar)** → Focus Search
...
### Header Badge Clicks
59. **Click Time Range Badge** → Set Time Range
...
60. **Click Sort Indicator** → Cycle Sort Order
...
61. **Click Pivot Indicator** → Cycle Pivot Mode
    - Handler: D:\code\dispatch\internal\tui\model.go (lines 1170-1198)
    - Behavior: Cycles pivot grouping mode
    - Condition: Click on Y=1, within pivot area

### Scroll Wheel (Mouse)
62. **Mouse Wheel Up (List Area)** → Scroll List Up
...
63. **Mouse Wheel Down (List Area)** → Scroll List Down
...
- **Mouse modifiers (Ctrl, Shift)** → Modify double-click launch behavior only
